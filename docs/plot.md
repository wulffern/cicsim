...
```bash
cicsim --no-color plot test.raw time "v(vn)" --fname "plot_1.svg" --no-show
```
...
```bash
cicsim --no-color plot test.raw time "somenode"  --no-show
```
...
```bash
cicsim --no-color plot test.raw time "v(vn),v(vp)" --fname "plot_2.svg" --no-show
```
...
```bash
cicsim --no-color plot test.raw time "v(vn),v(vp)" --fname "plot_3.svg" --ptype "same" --no-show
```
...
```bash
cicsim --no-color plot test.raw time "v(vn),v(vp)" --fname "plot_4.svg" --ptype "same,logy" --no-show
```
...
```bash
cicsim --no-color plot test.raw time "v(vn),v(vp)" --fname "plot_5.svg" --ptype "same,ln2" --no-show
```
...
```bash
cicsim --no-color plot test.raw time "v(vn),v(vp)" --fname "plot_6.svg" --ptype "same,logx" --no-show
```
...
```bash
cicsim --no-color plot test.raw time "v(vn),v(vp)" --fname "plot_7.svg" --ptype "same,db20" --no-show
```
